...
var geometry_CiculoLlantas = new THREE.CylinderGeometry(3.5, 3.5, 2, 32 );
var geometry_CuboLlanta = new THREE.CylinderGeometry( 1, 1, 7, 32 );
var geometry_CuboLlantaRinnes = new THREE.BoxGeometry(1,11,3,4);  
var geometry_CiculoGomaIN = new THREE.CylinderGeometry(13, 13, 5, 32 );
var geometry_CiculoGomaEX = new THREE.CylinderGeometry(18, 18, 4, 100 );

var geometry_CiculoCentro = new THREE.CylinderGeometry(1, 1, 3, 32 );

//Creacion malla

var LlantaEx = new THREE.Mesh(geometry_CiculoLlantas);
var LlantaRin= new THREE.Mesh(geometry_CuboLlanta);
var LlantaRin1= new THREE.Mesh(geometry_CuboLlanta);
var LlantaRin2= new THREE.Mesh(geometry_CuboLlanta);
var LlantaEjes= new THREE.Mesh(geometry_CuboLlantaRinnes);
...
LlantaRin1.applyMatrix(new THREE.Matrix4().makeTranslation(0,-5,6,0));
LlantaRin1.rotateX(-.90);
LlantaRin2.applyMatrix(new THREE.Matrix4().makeTranslation(0,-5,-6,0));
LlantaRin2.rotateZ(Math.PI);
LlantaRin2.rotateX(-.90);
LlantaEjes.applyMatrix(new THREE.Matrix4().makeTranslation(0,8,0,0));
LlantaEjes2.applyMatrix(new THREE.Matrix4().makeTranslation(0,-5,6,0));
LlantaEjes2.rotateX(-.90);
LlantaEjes3.applyMatrix(new THREE.Matrix4().makeTranslation(0,-5,-6,0));
LlantaEjes3.rotateX(.90 );
...
//mostrar 
  //scene.add(LlantaEx,LlantaRin,LlantaRin1,LlantaRin2,LlantaEjes,LlantaEjes2,LlantaEjes3);
  //scene.add(LlantaGomaIN,LlantaGomaEX,LlantaCentro);
...
L2.material_Negro=material_Negro; 
L3.material_Amarillo=material_Amarillo; 
...
var resulf= L2.subtract(L3);
//CONVERTIR A MALLA DE THREE JS NUEVAMENTE 

var ejej = THREE.CSG.toMesh(resul3);  
var LlantaFinalCorte  = THREE.CSG.toMesh(resulf);

//Material 
LlantaFinalCorte.material=material_Rojo;
ejej.material=material_Violeta;
...
PuntoCentral.add(LlantaFinalCorte);
PuntoCentral.add(ejej);

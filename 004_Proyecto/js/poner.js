            ...
            var cubeMaterial2 = new THREE.MeshLambertMaterial( { color: 0xFFFFFF, map: new THREE.TextureLoader().load( 'https://raw.githubusercontent.com/Kousei-edt/ProyectoFinal/master/assets/img/2.png' ),opacity: 1 } );
